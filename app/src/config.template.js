...
module.exports = {
    ...
    */
    ngrokAuthToken: '2Omnd4UqyqYiI7BY2NVcZhs3Qa8_4NRZYbufmNxniVbMhELy1',
    ...
    mediasoup: {
        ...
        webRtcTransport: {
            listenIps: [
                {
                    ip: '192.168.1.136',
                    announcedIp: '188.226.61.4', // replace by public static IP address https://api.ipify.org or put '' and will be auto-detected on server start
                },
            ],
