...
Repo: https://hub.docker.com/r/featly/talk
...
$ docker pull featlytalk/sfu:latest
...
```bash
# FeatlyTalk SFU - HTTPS — proxy all requests to the Node app
server {
	# Enable HTTP/2
...
Check Your FeatlyTalk SFU instance: https://your.domain.name/

---

## Update script

In order to have always Your FeatlyTalk SFU updated to latest, we going to create a script
...
Follow the commits of the FeatlyTalk SFU project [here](https://github.com/Featly-Inc/talk/commits/main)

To update your instance of FeatlyTalk SFU at latest commit, execute:
