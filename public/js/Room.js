...
function showAbout() {
    ...
    Swal.fire({
        ...
        <br/>
        <div id="about">
            <b><a href="https://github.com/Featly-Inc/talk" class="umami--click--github" target="_blank">Open Source</a></b> project
            <br/><br />
            <button class="pulsate umami--click--sponsors" onclick="window.open('https://github.com/sponsors/FEATLY-INC')"><i class="fas fa-heart"></i> Support</button>
            <br /><br />
            Author: <a href="https://www.linkedin.com/company/featlyapp/" class="umami--click--linkedin" target="_blank"> Featly Inc.</a>
        </div>
        `,
        showClass: {
            popup: 'animate__animated animate__fadeInDown',
